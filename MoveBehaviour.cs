...
public class MoveBehaviour : GenericBehaviour
{
    ...
    private int walkAimBool;                        // Animator variable related to walk aim.
    private bool jump;                              // Boolean to determine whether or not the player started a jump.
    private bool isColliding;                       // Boolean to determine if the player has collided with an obstacle.
    private Animator animator;
    private bool isAiming;                          // Boolean to check if player is aiming
    ...
    void Start()
    {
        ...
        walkAimBool = Animator.StringToHash("Walk Aim");
    ...
    void Update()
    {
        ...
        speed = new Vector2(horizontal, vertical).magnitude;

        // Update animator parameters
        animator.SetBool("Aim", isAiming);
        animator.SetFloat("Speed", speed);
        animator.SetBool("Walk Aim", isAiming && speed > 0.1f);
    }
    ...
    void JumpManagement()
    {
        ...
        if (jump && !behaviourManager.GetAnim.GetBool(jumpBool) && behaviourManager.IsGrounded())
        {
            ...
            if (behaviourManager.GetAnim.GetFloat("Speed") > 0.1f)
            {
    ...
    void MovementManagement(float horizontal, float vertical)
    {
        ...
        behaviourManager.GetAnim.SetFloat("Speed", speed, speedDampTime, Time.deltaTime);
    }
